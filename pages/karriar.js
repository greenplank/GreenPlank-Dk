...
const Karriar = () => {
  return (
    <>
      <Head>
        <title>Karriere - GreenPlank.dk</title>
        <meta name="title" content="Karriere - GreenPlank.dk" />
        <meta name="description" content="Green Plank er Sveriges førende leverandør af miljøvenlige byggematerialer. Siden starten i 2004 har virksomheden skabt et ry for at tilbyde byggevarer af høj kvalitet til den lavest mulige pris." />
      </Head>
      <Layout pageTitle="Karriere - GreenPlank.dk">
        <HeaderTwo />
