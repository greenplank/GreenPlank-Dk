...
import Imagecolor2 from "../assets/images/colors/primacap-fasadpanel-gp801/Beach-Grey.jpg";
import Imagecolor3 from "../assets/images/colors/primacap-fasadpanel-gp801/Snow-White.jpg";
...
const fasadpanelgp802 = () => {
  return (
    <>
      <Head>
        <title>PRIMACAP™ komposit facadebeklædning - GP802 - GreenPlank.dk</title>
        <meta name="title" content="PRIMACAP™ komposit facadebeklædning - GP802 - GreenPlank.dk" />
        <meta name="description" content="komposit facadebeklædning GP802. Dette lette, brandhæmmende, superholdbare kompositpanel med lav vedligeholdelse er belagt med en revolutionerende ASA-kappe." />
      </Head>
      <Layout pageTitle="PRIMACAP™ komposit facadebeklædning - GP802 - GreenPlank.dk">
        <HeaderTwo />
        <StickyHeader />
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={6} sm={2}>
                              <div className="single-gallery-project__image">
                                ...
                                <h4 className="mt-20 text-center">Snow White</h4>
                              </div>
                            </Grid>
                          </Grid>
                        </div>
