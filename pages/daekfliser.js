...
const golvplattor = () => {
    return (
        <>
            <Head>
                <title>Gulvklinker og komposit terrassefliser i komposit - GreenPlank.dk</title>
                <meta name="title" content="Gulvklinker og komposit terrassefliser i komposit - GreenPlank.dk" />
                <meta name="description" content="Gulvfliser og komposit altaner er perfekte til at genskabe udendørs gulve såsom terrasser, tage, altaner og dækning af hårde indendørs gulve." />
            </Head>
            <Layout pageTitle="Gulvklinker og komposit terrassefliser i komposit - GreenPlank.dk">
                <HeaderTwo />
