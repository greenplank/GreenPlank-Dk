...
const Garantier = () => {
  return (
    <>
      <Head>
        <title>Garanti - GreenPlank.dk</title>
        <meta name="title" content="Garanti - GreenPlank.dk" />
        <meta name="description" content="Alle kompositprodukter fra Green Plank har brancheførende garantidækning. Se niveauet af support, hvert produkt har her." />
      </Head>
      <Layout pageTitle="Garanti - GreenPlank.dk">
        <HeaderTwo />
