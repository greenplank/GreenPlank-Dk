...
const kompositstaketprivate = () => {
  return (
    <>
      ...
      <Head>
        <title>Komposithegn NOVOFENCE™ Private™ - GreenPlank.dk</title>
        <meta name="title" content="Komposithegn NOVOFENCE™ Private™ - GreenPlank.dk" />
        <meta name="description" content="Komposithegn er designet til at beskytte din have mod naboer, passagerer og andre skadelige dyr, der giver dit hjem et elegant præg." />
      </Head>

      <Layout pageTitle="Komposithegn NOVOFENCE™ Private™ - GreenPlank.dk ">
        <HeaderTwo />
        <StickyHeader />
