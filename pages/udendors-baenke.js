...
const Plankor = () => {
    return (
        <>
            <Head>
                <title>Højkvalitets kompositplanker &amp; Komposit terrassebrædder | - GreenPlank.dk</title>
                <meta name="title" content="Højkvalitets kompositplanker &amp; Komposit terrassebrædder | - GreenPlank.dk" />
                <meta name="description" content="Planker giver en glat tekstur, der er nem at rengøre og nem at vedligeholde. Det er vandtæt og kan bruges som en økonomisk mimeografi af keramiske fliser." />
            </Head>
            <Layout pageTitle="Højkvalitets kompositplanker &amp; Komposit terrassebrædder | - GreenPlank.dk">
                <HeaderTwo />
