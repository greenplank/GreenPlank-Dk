...
const Resurser = () => {
  ...
  return (
    <>
      <Head>
        <title>Ressourcer - GreenPlank.dk</title>
        <meta name="title" content="Ressourcer - GreenPlank.dk" />
        <meta name="description" content="Greenplank tekniske dokumenter, installationsvejledninger, vedligeholdelsesvejledninger, YouTube-videolinks" />
      </Head>
      <Layout pageTitle="Ressourcer - GreenPlank.dk">
        <HeaderTwo />
