...
const BliCertifieradHantverkare = () => {
  return (
    <>
      <Head>
        <title>Bliv Green Plank certificeret håndværker - GreenPlank.dk</title>
        <meta name="title" content="Bliv Green Plank certificeret håndværker - GreenPlank.dk" />
        <meta name="description" content="Vores professionelle installationsprogram deler avanceret installationsteknologi blandt dygtige installatører" />
      </Head>
      <Layout pageTitle="Bliv Green Plank certificeret håndværker - GreenPlank.dk">
        <HeaderTwo />
